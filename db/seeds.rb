...
Dir.glob("./db/*.jpg") {|f| photo=Photo.new; photo.contents=File.open(f,'rb'); photo.save}
Photo.all.each {|photo| place_id=photo.find_nearest_place_id 22000609; photo.place=place_id; photo.save}
